...
function resetGhosts() {
  ...
  // GHOST_BLINKY_IMG = document.getElementById('pacmanImage');
  ...
  // GHOST_PINKY_IMG = document.getElementById('pacmanImage');
  ...
  // GHOST_INKY_IMG = document.getElementById('pacmanImage');
  ...
  // GHOST_CLYDE_IMG = document.getElementById('pacmanImage');
}
...
function drawHelperGhost(ctx, x, y, d, b, s, a, img) {
  /* ctx.beginPath();
